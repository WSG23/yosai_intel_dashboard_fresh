        ...
        for test_name, test_func in tests:
            ...
            try:
                ...
                result["tests"][test_name.lower().replace(" ", "_")] = {
                    ...
                    "summary": str(test_result)[:200] + "..." if len(str(test_result)) > 200 else str(test_result)
                }
                
                if test_name == "Data Processing":
                    print(f"✅ {test_name}: Processed {len(test_result)} rows")
                elif test_name == "Data Summary":
                    print(f"✅ {test_name}: {test_result.get('rows', 'N/A')} rows, {test_result.get('columns', 'N/A')} columns")
