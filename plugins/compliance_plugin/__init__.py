...
def create_app_with_compliance_plugin(config_name: str = None) -> Flask:
    ...
    try:
        ...
        if compliance_plugin and compliance_plugin.initialize(
            container, config_manager.to_dict()
        ):
            ...
            return jsonify(
                {
                    ...
                    "compliance_status": pre_process_result.get(
                        "compliance_metadata", {}
                    ),
                }
            )
