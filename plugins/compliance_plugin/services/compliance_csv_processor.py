...
class ComplianceCSVProcessor:
    ...
    def process_csv_with_compliance(
        ...
        try:
            ...
            storage_result = self._store_csv_with_compliance(
                processed_data, classification, upload_context, processing_id, uploaded_by
            )
    ...
    def _classify_csv_data(self, df: pd.DataFrame, context: Dict[str, Any]) -> DataClassificationResult:
        ...
        if 'access_logs' in result.data_types_detected and 'person_id' in result.data_types_detected:
    ...
    def _check_consent_requirements(
        ...
        consent_status = {
            ...
            'consent_types_needed': [ct.value for ct in classification.consent_types_required],
        ...
        if 'person_id' not in classification.data_types_detected:
            ...
            consent_status['consent_check_results']['uploader'] = 'consent_from_uploader_sufficient'
            return consent_status
        ...
        if upload_consent_confirmed or data_controller_authority:
            consent_status['consent_check_results']['bulk_consent'] = 'confirmed_by_uploader'
        else:
    ...
    def _process_csv_data_with_compliance(
        ...
        df_processed['_compliance_sensitivity_level'] = classification.sensitivity_level.value
        df_processed['_compliance_legal_basis'] = classification.legal_basis_recommendation
        df_processed['_compliance_retention_policy'] = classification.retention_policy_recommendation
    ...
    def delete_user_csv_data(self, user_id: str) -> bool:
        ...
        try:
            ...
            for csv_data in csv_data_list:
                ...
                anonymized_df.to_parquet(f"{storage_location}/data.parquet", index=False)
