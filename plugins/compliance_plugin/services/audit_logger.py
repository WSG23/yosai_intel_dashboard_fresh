...
class ComplianceAuditLogger:
    ...
    def log_action(
        ...
        try:
            ...
            if data_categories:
                try:
                    import json
                    safe_data_categories = json.dumps(data_categories, ensure_ascii=False)
                except Exception as e:
    ...
    def generate_compliance_report(
        ...
        try:
            ...
            activity_summary = summary_df.to_dict('records') if not summary_df.empty else []
            ...
            legal_basis_summary = legal_df.to_dict('records') if not legal_df.empty else []
