...
from core.error_handling import error_handler, handle_errors, ErrorSeverity
...
class ComplianceMiddleware:
    ...
    @handle_errors(service="compliance_middleware", operation="before_request", severity=ErrorSeverity.HIGH)
    ...
    @handle_errors(service="compliance_middleware", operation="after_request", severity=ErrorSeverity.HIGH)
    ...
    @handle_errors(service="compliance_middleware", operation="teardown_request", severity=ErrorSeverity.HIGH)
    ...
    @handle_errors(service="compliance_middleware", operation="log_request_start", severity=ErrorSeverity.HIGH)
    ...
    @handle_errors(service="compliance_middleware", operation="add_compliance_headers", severity=ErrorSeverity.HIGH)
    ...
    @handle_errors(service="compliance_middleware", operation="get_user_id_from_request", severity=ErrorSeverity.MEDIUM)
