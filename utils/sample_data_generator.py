...
def generate_sample_access_data(num_records=1000):
    ...
    # Sample doors
    doors = [
        "MAIN_ENTRANCE", "SERVER_ROOM_A", "EXECUTIVE_FLOOR", 
        "LAB_ENTRANCE", "CLEAN_ROOM", "PARKING_GATE",
        "CAFETERIA", "MEETING_ROOM_A", "MEETING_ROOM_B",
        "STORAGE_A", "EMERGENCY_EXIT_1", "EMERGENCY_EXIT_2"
    ]
